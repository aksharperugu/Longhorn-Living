const TEAM = [
  { name: 'Akshar Perugu', linkedin: 'aksharperugu' },
]
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:py-24">
      ...
      <p className="mt-6 text-lg text-stone-600">
        I'm a student at the University of Texas at Austin. I built Longhorn Living to help
        students find off-campus apartments near campus—with availability, cost, distance,
        and pros and cons in one place.
      </p>
      <section className="mt-12">
        <h2 className="text-xl font-semibold text-stone-900">Who's behind this</h2>
