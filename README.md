...
1. Clone the repository:
   ```bash
   git clone https://github.com/aksharperugu/longhorn-living.git
   cd longhorn-living
   ```
...
Built by **Akshar Perugu**, a student at the University of Texas at Austin — [LinkedIn](https://linkedin.com/in/aksharperugu)
